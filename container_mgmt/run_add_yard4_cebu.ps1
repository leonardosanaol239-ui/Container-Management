...
# ============================================================================
# This script executes the SQL to add Yard 4 to Cebu Port with Y4.png
# ============================================================================

Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host "ADDING YARD 4 TO CEBU PORT WITH Y4.PNG" -ForegroundColor Cyan
Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host ""
...
$SqlFile = "database/add_yard4_cebu.sql"
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "✅ SUCCESS! Yard 4 added to Cebu Port with Y4.png" -ForegroundColor Green
        Write-Host "============================================================================" -ForegroundColor Green
        Write-Host ""
        Write-Host "Database Changes:" -ForegroundColor Yellow
        Write-Host "  ✅ Yard 4 created in Cebu Port (PortId = 2)" -ForegroundColor White
        Write-Host "  ✅ ImagePath set to 'Y4.png'" -ForegroundColor White
        Write-Host "  ✅ All Cebu yards updated for consistency" -ForegroundColor White
        Write-Host "  ✅ Integrity checks passed" -ForegroundColor White
        Write-Host ""
        ...
        Write-Host "4. Y4.png will be displayed as the background" -ForegroundColor White
        Write-Host ""
    } else {
        Write-Host ""
