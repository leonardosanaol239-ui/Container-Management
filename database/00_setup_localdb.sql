-- Complete LocalDB Setup for Container Management System
-- This script creates the database and all required data

-- Create database if it doesn't exist
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'ContainerManagement')
BEGIN
    CREATE DATABASE ContainerManagement;
    PRINT 'Database ContainerManagement created successfully!';
END
ELSE
BEGIN
    PRINT 'Database ContainerManagement already exists.';
END
GO
